...
# Train
model.fit(X, y_encoded, epochs=100, batch_size=32, sample_weight=sample_weights)
...
model.save("my_model3.keras")  # Saves the full model (architecture + weights + optimizer)
